...
void RK4(double dt,double *q1, double *q3, double *p1, double *p3,double e){
  ...
  m2=q3prime(dt,q1in+k1*dt/2,q3in+m1*dt/2,p1in+l1*dt/2 ,p3in+n1*dt/2,e);
  n2=p3prime(dt,q1in+k1*dt/2,q3in+m1*dt/2,p1in+l1*dt/2 ,p3in+n1*dt/2,e);
  ...
  m3=q3prime(dt,q1in+k2*dt/2,q3in+m2*dt/2,p1in+l2*dt/2 ,p3in+n2*dt/2,e);
  n3=p3prime(dt,q1in+k2*dt/2,q3in+m2*dt/2,p1in+l2*dt/2 ,p3in+n2*dt/2,e);  
 

  k4=q1prime(dt,q1in+k3*dt,q3in+m3*dt,p1in+l3*dt ,p3in+n3*dt,e);
  l4=p1prime(dt,q1in+k3*dt,q3in+m3*dt,p1in+l3*dt ,p3in+n3*dt,e);
  m4=q3prime(dt,q1in+k3*dt,q3in+m3*dt,p1in+l3*dt ,p3in+n3*dt,e);
  n4=p3prime(dt,q1in+k3*dt,q3in+m3*dt,p1in+l3*dt ,p3in+n3*dt,e); 
